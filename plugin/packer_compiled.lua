...
_G.packer_plugins = {
  ...
  delimitMate = {
    loaded = true,
    path = "/home/henry/.local/share/nvim/site/pack/packer/start/delimitMate",
  ...
  ["nvim-transparent"] = {
    loaded = true,
    path = "/home/henry/.local/share/nvim/site/pack/packer/start/nvim-transparent",
  ...
  ["vim-table-mode"] = {
    loaded = true,
    path = "/home/henry/.local/share/nvim/site/pack/packer/start/vim-table-mode",
